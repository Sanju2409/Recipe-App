...
Context context;
List<Recipe> list;
RecipeClickLisreners lisrener;

    public RandomReciepeAdapter(Context context, List<Recipe> list,RecipeClickLisreners lisrener) {
        this.context = context;
        this.list = list;
        this.lisrener=lisrener;
    }
    ...
    public void onBindViewHolder(@NonNull RandomReciepeViewHolder holder, int position) {
        ...
        holder.random_list_container.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                lisrener.onRecipeClicked(String.valueOf(list.get(holder.getAdapterPosition()).id));
            }
        });
    }
